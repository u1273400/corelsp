...
namespace corelsp.Shared.Models
{
    public class Building
    {
        ...
        public static object[] bldcols = new object[]{
            new{id= "id", name= "Id", field= "id", behavior= "select", cssClass= "cell-selection", width= 40, cannotTriggerInsert= true, resizable= false, defaultSortAsc= true, selectable= false },
